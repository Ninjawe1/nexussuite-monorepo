...
export function PlayerAddDialog({ open, onOpenChange }: PlayerAddDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto" data-testid="dialog-add-player">
        <DialogHeader>
          <DialogTitle>Add Player</DialogTitle>
          <DialogDescription>Capture player info, contract, and payroll in one step.</DialogDescription>
        </DialogHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-muted-foreground">Player Info</h3>
              <FormField
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl><Input placeholder="contract.pdf" {...field} /></FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl><Input placeholder="https://storage/contract.pdf" {...field} /></FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
