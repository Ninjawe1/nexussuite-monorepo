...
describe('RosterTab', () => {
  ...
  it('renders roster tab with header and stats', () => {
    ...
    expect(screen.getByText('Manage your team rosters, assign players, and track team composition')).toBeInTheDocument();
  ...
  it('shows empty state when no rosters exist', () => {
    ...
    expect(screen.getByText('No rosters found. Create your first roster to get started with team management.')).toBeInTheDocument();
  });
