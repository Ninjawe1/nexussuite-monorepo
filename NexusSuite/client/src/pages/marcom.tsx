      ...
      <Tabs defaultValue="analytics" className="space-y-6">
        ...
        <TabsContent value="analytics" className="space-y-6">
              ...
              <CardContent>
                {analyticsLoading ? (
                  ...
                  <>
                    ...
                    >
                      {((socialAnalytics?.totalFollowers || 0) / 1000).toFixed(
                        1,
                      )}
                      K
                    </div>
                ...
                {analyticsLoading ? (
                  ...
                  <>
                    <div className="text-3xl font-bold font-mono">
                      {((socialAnalytics?.totalEngagement || 0) / 1000).toFixed(
                        1,
                      )}
                      K
                    </div>
          ...
          {socialAnalytics?.platforms &&
            socialAnalytics.platforms.length > 0 && (
              <div>
                <h3 className="text-lg font-heading font-semibold mb-4">
                  Platform Breakdown
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {socialAnalytics.platforms.map(
                    (platform: any, index: number) => {
                      const Icon =
                        platformIcons[platform.platform] || BarChart3;
                      return (
                        <Card key={index}>
