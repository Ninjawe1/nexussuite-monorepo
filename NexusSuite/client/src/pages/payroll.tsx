...
export default function Payroll() {
  ...
  return (
    <div className="p-6 space-y-6">
            ...
            {isLoading ? (
              ...
              <>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {payrollEntries.filter(e => e.status === 'paid').length} transactions
                </p>
              </>
            )}
          </CardContent>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {payrollEntries.filter(e => e.status === 'pending').length} transactions
                </p>
              </>
            )}
          </CardContent>
              ...
              <TableBody>
                {payrollEntries.map(entry => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge
                        variant={entry.type === 'monthly' ? 'secondary' : 'outline'}
                        className="text-xs"
                      >
      ...
      <PayrollDialog open={dialogOpen} onOpenChange={setDialogOpen} payroll={selectedPayroll} />
    </div>
  );
}
