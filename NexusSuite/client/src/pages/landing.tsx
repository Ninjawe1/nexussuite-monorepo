...
export default function Landing() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Handle player salaries, prize pool distribution, and bonuses with precision.',
    },
    {
      icon: BarChart3,
      title: 'Performance Analytics',
      description: 'Track scrim results, individual stats, and social engagement metrics.',
    },
    {
      icon: FileText,
      title: 'Smart Contracts',
      description: 'Digitally sign and store player contracts, sponsorship deals, and NDAs.',
    },
    {
      icon: MonitorPlay,
      title: 'Content Pipeline',
      description: 'Streamline asset requests for thumbnails, overlays, and social graphics.',
    },
  ];
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="flex flex-col items-center gap-8 max-w-4xl mx-auto relative z-10">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
              The all-in-one platform to manage rosters, streamline operations, and scale your
              organization. <span className="text-white">Built for champions.</span>
            </p>
                  ...
                  <div className="h-32 flex items-end gap-2">
                    {[40, 60, 45, 70, 65, 80, 75, 60, 55, 85, 90, 70].map((h, i) => (
                      <div
                        key={i}
                        style={{ height: `${h}%` }}
                        className="flex-1 bg-primary/20 hover:bg-primary/50 transition-colors rounded-sm cursor-pointer group relative"
                      >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Stop using spreadsheets. NexusSuite provides a professional operating system tailored
              for the unique needs of esports organizations.
            </p>
          </div>
      ...
      <section className="py-24 bg-primary/5 border-y border-primary/10 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              <div className="text-5xl font-bold font-mono mb-2 text-primary">$250M+</div>
              <p className="text-muted-foreground uppercase tracking-wider text-sm">
                Prize Money Tracked
              </p>
            </div>
            <div className="p-6 border-x border-primary/10">
              <div className="text-5xl font-bold font-mono mb-2 text-primary">5,000+</div>
              <p className="text-muted-foreground uppercase tracking-wider text-sm">
                Active Players
              </p>
            </div>
            <div className="p-6">
              <div className="text-5xl font-bold font-mono mb-2 text-primary">99.9%</div>
              <p className="text-muted-foreground uppercase tracking-wider text-sm">
                Uptime Reliability
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto glass border border-primary/20 rounded-3xl p-12 md:p-20 relative overflow-hidden">
            ...
            <p className="text-xl text-muted-foreground mb-10">
              Be among the first to experience the future of esports management. Sign up now to
              secure your spot.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-2">
              ...
              <p className="text-muted-foreground max-w-sm">
                The premier operating system for esports organizations, creative agencies, and
                gaming communities.
              </p>
            </div>
            <div>
