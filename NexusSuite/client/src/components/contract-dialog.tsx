  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="player_contract_2024.pdf"
                      {...field}
                      data-testid="input-contract-filename"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      data-testid="input-contract-fileurl"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        data-testid="input-contract-linkedperson"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
        ...
        {/* Attachments section: only for existing contracts */}
        {contract?.id ? (
          <div className="mt-6">
        ...
        {/* Footer retained above within form submit buttons */}
      </DialogContent>
    </Dialog>
  );
}
