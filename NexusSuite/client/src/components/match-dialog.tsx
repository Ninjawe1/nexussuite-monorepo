              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Nexus Valorant"
                        {...field}
                        data-testid="input-match-teamA"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="VCT Champions"
                        {...field}
                        data-testid="input-match-tournament"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="Online, LA Studio, etc."
                      {...field}
