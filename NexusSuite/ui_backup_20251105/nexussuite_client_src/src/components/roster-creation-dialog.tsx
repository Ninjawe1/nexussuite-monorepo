...
const rosterFormSchema = z.object({
  name: z.string()
    ...
    .regex(/^[a-zA-Z0-9\s-_]+$/, 'Roster name can only contain letters, numbers, spaces, hyphens, and underscores'),
...
const rosterTypes = [
  { value: 'International competitive', label: 'International competitive', description: 'Teams for international tournaments' },
  { value: 'Local Competitive', label: 'Local Competitive', description: 'Teams for local/regional competitions' },
  { value: 'Academy', label: 'Academy', description: 'Development/feeder teams' },
];
